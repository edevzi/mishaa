    ...
    <div className="fixed bottom-32 left-10 z-[600] w-80 pointer-events-none">
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="pointer-events-auto bg-white/90 backdrop-blur-3xl border border-black/10 rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.08)]"
          >
            <div className="p-5 flex items-center gap-4 border-b border-black/5 bg-gradient-to-r from-[var(--accent)]/10 to-transparent">
      ...
      {!isOpen && (
         <motion.button 
            ...
            className="pointer-events-auto w-12 h-12 bg-white/90 backdrop-blur-xl border border-black/10 rounded-2xl flex items-center justify-center text-[var(--accent)] shadow-2xl hover:bg-[var(--accent)] hover:text-white transition-all"
         >

      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full bg-neutral-100 py-6 text-[11px] font-black uppercase tracking-[0.2em] text-neutral-500 transition-all duration-500 hover:bg-neutral-200 hover:text-neutral-900 dark:bg-white/5 dark:text-white/40 dark:hover:bg-white/10 dark:hover:text-white"
          >
            {cancelLabel}
          </button>
        </div>

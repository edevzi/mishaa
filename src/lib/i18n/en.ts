export const en = {
    ...
    hero: {
      ...
      pageH1: 'Read manga, manhwa & webtoons in your browser',
      featuredSeries: 'Featured',
      readFeaturedCta: 'Read now',
      desc: 'Search catalogs, open chapters fullscreen, keep bookmarks—all without installing an app. MangaDex-style manga, scrolling webtoons, manhwa, and optional age‑gated shelves after you verify. English/Russian UI.',
      cta: 'Explore Library',
      launch: 'Browse All',
      issue: 'Issue',

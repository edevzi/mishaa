        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-6xl mx-auto space-y-10">
          <section className="space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/50">User Controls</span>
            </div>
          ...
          <section className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-xl">
              ...
              <select
                ...
                className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-[10px] font-black uppercase tracking-[0.3em] outline-none"
              >
              ...
              <div className="grid gap-2">
                <button
                  ...
                  className={`rounded-2xl border px-4 py-3 text-[10px] font-black uppercase tracking-[0.35em] transition-all ${
                    ageEnabled ? 'border-[#ff4d00] bg-[#ff4d00] text-white' : 'border-white/10 bg-black/30 text-white/45 hover:border-white/25 hover:text-white'
                  }`}
                >
                  Enable 18+
                </button>
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-[10px] font-black uppercase tracking-[0.35em] text-white/45 transition-all hover:border-white/25 hover:text-white"
                >
                  Disable 18+
                </button>
              </div>
          ...
          <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 md:p-8 backdrop-blur-xl">
              <div className="flex items-center justify-between gap-4 mb-6">
                ...
                <div className="text-right text-[9px] font-black uppercase tracking-[0.35em] text-white/30">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <Link href="/library" className="rounded-2xl border border-white/10 bg-black/30 p-4 hover:border-[#ff4d00]/40 transition-all">
                  <div className="text-[9px] font-black uppercase tracking-[0.4em] text-white/30">Browse</div>
                  <div className="mt-2 text-lg font-black uppercase tracking-tight">Open Library</div>
                </Link>
                <Link href="/support" className="rounded-2xl border border-white/10 bg-black/30 p-4 hover:border-[#ff4d00]/40 transition-all">
                  <div className="text-[9px] font-black uppercase tracking-[0.4em] text-white/30">Report</div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-[10px] font-black uppercase tracking-[0.35em] text-white/45 transition-all hover:border-red-500/40 hover:text-red-400"
                >
                  <Trash2 size={14} />
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 md:p-8 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                <a href="mailto:info@icomics.wiki?subject=iComics%20Support%20Report" className="block rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-[10px] font-black uppercase tracking-[0.35em] text-white/60 transition-all hover:border-white/25 hover:text-white">
                  Email support
                </a>
                <a href="https://t.me/icomicsuz" target="_blank" rel="noreferrer" className="block rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-[10px] font-black uppercase tracking-[0.35em] text-white/60 transition-all hover:border-white/25 hover:text-white">
                  Telegram dispatch
                </a>
                <Link href="/support" className="block rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-[10px] font-black uppercase tracking-[0.35em] text-white/60 transition-all hover:border-white/25 hover:text-white">
                  Open full support form
                </Link>
                <Link href="/profile" className="block rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-[10px] font-black uppercase tracking-[0.35em] text-white/60 transition-all hover:border-white/25 hover:text-white">
                  Account profile
                </Link>
              </div>
            </div>
          ...
          <section className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 md:p-8 backdrop-blur-xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {readRecentHistoryItems(6).map((item) => (
                <Link
                  ...
                  href={item.href}
                  className="rounded-2xl border border-white/10 bg-black/30 p-4 hover:border-[#ff4d00]/40 transition-all"
                >
                  ...
                  <div className="mt-2 text-[10px] text-white/35 line-clamp-2">
          ...
          <section className="rounded-[2rem] border border-white/10 bg-gradient-to-r from-[#ff4d00]/15 via-white/[0.03] to-white/[0.03] p-6 md:p-8">
            ...
            <Link
              href="/support"
              className="mt-5 inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-black px-5 py-3 text-[10px] font-black uppercase tracking-[0.35em] text-white transition-all hover:bg-[#ff4d00]"
            >
              Open Support Form
            </Link>
          </section>
